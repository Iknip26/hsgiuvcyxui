...
<html
  ...
  <head>
    ...
    <title>Login Basic - Pages | RKAKL - RKAKL Design HTML Admin Template</title>
  ...
  <body>
    ...
    <div class="body">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-wrapper authentication-basic container-p-y">
          <!-- Login -->
          <div class="card p-2 sayang">
            <!-- Logo -->
            <center>
              <img src="https://apiportal.postel.go.id/images/1675227345_LOGO%20SDPPI.png" class="logo">
            </center>
            ...
            <div class="card-body mt-2">
              ...
              <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-white d-grid w-100" type="submit">Login</button>
                </div>
              </form>

              <div class="divider my-4 white">
                <div class="divider-text" style="color: white;">or</div>
              </div>

              <div class="mb-3">
                <button class="btn btn-secondary d-grid w-100" type="submit">SSO</button>
              </div>
            </div>
          </div>
          <!-- /Login -->
