                                    ...
                                    <thead>
                                      <tr>
                                        <th scope="col">
                                            <div class="col-md-6">
                                                <div class="row">
                                                  <div class="col" style="padding-right: 80px;  margin-left: -12px;">
                                                    <select id="collapsible-state" class="select2 form-select" data-allow-clear="true">
                                                        <option value="">52</option>
                                                        <option value="AL">53</option>
                                                        <option value="AK">54</option>
                                                        <option value="AZ">55</option>
                                                    </select>
                                                  </div>
                                        </th>
                                        <p>
                                        <th scope="col">
                                            <div class="col-md-6">
                                                <div class="row">
                                                  <div class="col" style="padding-right: 80px; margin-left: -350px;">
                                                    <select id="collapsible-state" class="select2 form-select" data-allow-clear="true">
                                                        <option value="">52</option>
                                                        <option value="AL">53</option>
                                                        <option value="AK">54</option>
                                        ...
                                        <th scope="col">
                                            <div class="col-md-6">
                                                <div class="row">
                                                  <div class="col" style="padding-right: 5px; margin-left: -120px;">
                                                    <select id="collapsible-state" class="select2 form-select" data-allow-clear="true">
                                                        <option value="">52</option>
                                                        <option value="AL">53</option>
                                                        <option value="AK">54</option>
              ...
              <div class="col-lg-12">
                <div class="card text-right">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form>
                                <button class="btn btn-primary btn-initialize">Create New</button>
                    ...
                    <table class="datatables-permissions table">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th></th>
                          <th>521253</th>
                          <th>Belanja Barang Ekstrakomptabel</th>
                          <th>Belanja Peralatan dan Mesin Ekstrakomptabel</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <thead>
                        <tr>
                          ...
                          <th>521254</th>
                          <th>Belanja Barang Ekstrakomptabel</th>
                          <th>Belanja Gedung dan Bangunan Ekstrakomptabel</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <thead>
                        <tr>
                          ...
                          <th>521255</th>
                          <th>Belanja Barang Ekstrakomptabel</th>
                          <th>Belanja Aset Tetap Lainnya Ekstrakomptabel</th>
                          <th>
                            <tr>
                                <th><i class="fi fi-rr-pencil"></i></th>
                                <th><i class="fi fi-rs-trash"></i></th>
                                <th></th>
                            </tr>
                          </th>
                        </tr>
